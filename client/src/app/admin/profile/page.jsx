...
export const metadata = {
  title: "Next.js Profile | AdminLTE-Demo - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for AdminLTE-Demo - Next.js Tailwind CSS Admin Dashboard Template",
};
...
export default async function Profile() {
  ...
  return (
    <div className="mx-auto max-w-[970px]">
      <div className="overflow-hidden rounded-sm border border-[#E2E8F0] bg-white shadow-default dark:border-[#2E3A47] dark:bg-[#24303F]">
        <div className="relative z-20 h-[140px] md:h-[260px]">
          ...
          <div className="absolute bottom-1 right-1 z-10 sm:bottom-4 sm:right-4">
            <label
              htmlFor="background"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary px-2 py-1 text-sm font-medium text-white hover:bg-opacity-80 sm:px-4"
            >
              <input
                type="file"
                name="background"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11 dark:text-[#AEB7C0]">
          <div className="relative z-30 mx-auto -mt-[88px] h-[120px] w-full max-w-[120px] rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <Image
                src="/images/min-min.png"
          ...
          <p className="font-medium text-[#64748B]">Web Developer</p>

          <div className="mx-auto mb-5 mt-4 grid max-w-[376px] grid-cols-3 rounded-md border border-[#E2E8F0] py-2.5 shadow-1 dark:border-[#2E3A47] dark:bg-[#37404F]">
            <div className="flex flex-col items-center justify-center gap-1 border-r border-[#E2E8F0] px-4 dark:border-[#2E3A47] sm:flex-row">
